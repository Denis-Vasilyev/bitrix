...
?>
<div>
    <button onclick="window.location.href = '?sort_id=UF_DATE&sort_type=ASC' + ((new URLSearchParams(window.location.search).get('page')) ? ('&page=' + new URLSearchParams(window.location.search).get('page')) : '')">Сортировать по дате (возрастание)</button>
    <button onclick="window.location.href = '?sort_id=UF_DATE&sort_type=DESC' + ((new URLSearchParams(window.location.search).get('page')) ? ('&page=' + new URLSearchParams(window.location.search).get('page')) : '')">Сортировать по дате (убывание)</button>
    <button onclick="window.location.href = '?sort_id=UF_FIO&sort_type=ASC' + ((new URLSearchParams(window.location.search).get('page')) ? ('&page=' + new URLSearchParams(window.location.search).get('page')) : '')">Сортировать по ФИО (убывание)</button>
    <button onclick="window.location.href = '?sort_id=UF_FIO&sort_type=DESC' + ((new URLSearchParams(window.location.search).get('page')) ? ('&page=' + new URLSearchParams(window.location.search).get('page')) : '')">Сортировать по ФИО (возрастание)</button>
</div>
